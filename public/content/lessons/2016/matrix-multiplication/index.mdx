...
One matrix is rotating by $90^\circ$ counterclockwise. The other matrix is scaling by $-2$ (rotating by $180^\circ$ and multiplying by $2$). Does it matter if we first rotate and then scale, or can we also scale and then rotate?
